...
export const metadata: Metadata = {
  ...
  description: `${SITE.name} · N°1 dello Smash Burger a Scalea (CS). 100% carne di scottona italiana, zero additivi, nessun compromesso. Scopri il Panino del Mese e ordina ora.`,
  ...
  openGraph: {
    ...
    description:
      "N°1 dello Smash Burger a Scalea. 100% carne di scottona italiana, zero additivi.",
